...
export class Socket extends EventEmitter {
  ...
  private readonly acks: object = {};
  private readonly fns: Array<Function> = [];
  private flags: any = {};
   ...
   * @return {Socket} self
   */
  public join(rooms, fn?: Function): Socket {
   ...
   * @return {Socket} self
   */
  public leave(room: string, fn?: Function): Socket {
   ...
   */
  private run(event: Array<any>, fn: Function): void {
